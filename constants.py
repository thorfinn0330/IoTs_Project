...
AIO_KEY = "aio_MefL406gcn1V0npGR0pavFZIb8qP!!!!!!!!!!!!!"
#MQTT HEADER
HEADER_GETWAY_REQUEST_TASK = 0
HEADER_SERVER_SEND_TASK = 1
HEADER_GATEWAY_SEND_SENSOR_VALUE = 2
HEADER_GATEWAY_SEND_TASK_STATUS = 3
HEADER_GATEWAY_SEND_ACK = 4
HEADER_SERVER_DELETE_TASK = 5
#FSM State
INIT = 0
MIXER_1 = 1
MIXER_2 = 2
